...
<%
try{
	int aircraftID = Integer.parseInt(request.getParameter("aircraftIDToDelete"));
	ApplicationDB db = new ApplicationDB();	
	Connection con = db.getConnection();
	Statement stmt = con.createStatement();
	CustomerRepStatements.deleteAircraft(con, aircraftID);
	con.close();
	...
	out.println(e);
	out.print("Could not Delete Aircraft");
}
