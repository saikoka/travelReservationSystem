...
<%
try{
	int aircraftID = Integer.parseInt(request.getParameter("aircraftToAdd"));
	int airlineID = Integer.parseInt(request.getParameter("airlineToAddAircraftTo"));
	ApplicationDB db = new ApplicationDB();	
	Connection con = db.getConnection();
	Statement stmt = con.createStatement();
	CustomerRepStatements.addAircraft(con, aircraftID, airlineID);
	con.close();
	...
	out.println(e);
	out.print("Could not Add Aircraft");
}
